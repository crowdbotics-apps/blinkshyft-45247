"""
Django settings for odd_pond_45247 project.
...
ROOT_URLCONF = 'odd_pond_45247.urls'
...
WSGI_APPLICATION = 'odd_pond_45247.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_pond_45247 API",
    "DESCRIPTION": "API documentation for odd_pond_45247 App",
    "VERSION": "v1",
}
